...
CCDEFINES_ST = '-D%s'
CCFLAGS = ['-Wno-error', '-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
CCFLAGS_DEBUG = ['-g']
...
COMPILER_CXX = 'g++'
CPP = '/usr/bin/cpp'
CPPFLAGS = ['-Wno-error', '-Wno-error']
CPPPATH = ['/usr/local/src/click-2.0/include']
...
CPPPATH_NSCLICK = ['/usr/local/src/click-2.0/include']
CPPPATH_PYEMBED = ['/usr/include/python2.7']
CPPPATH_PYEXT = ['/usr/include/python2.7']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES = ['_DEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'NS3_CLICK']
CXXDEFINES_ST = '-D%s'
...
LIBPATH_NSCLICK = ['/usr/local/src/click-2.0/ns']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.6', '/usr/local/src/click-2.0/lib', '/usr/local/src/click-2.0/ns', '/usr/local/src/ns-3-click-mac-dev/build/debug']
...
WITH_NSCLICK = '/usr/local/src/click-2.0'
