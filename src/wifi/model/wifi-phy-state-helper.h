...
public:
  ...
  void SwitchFromRxEndOk (Ptr<Packet> packet, double snr, WifiMode mode, enum WifiPreamble preamble, RadiotapHeader radiotaphdr);
...
private:
  ...
  TracedCallback<Ptr<const Packet>, double, WifiMode, enum WifiPreamble, RadiotapHeader> m_rxOkTrace;
