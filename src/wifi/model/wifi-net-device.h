...
public:
  ...
  /**
   * Sets device in Monitor Mode. Must be done only if WifiNetDevice
   * has a MonitorMacHigh underneath
   */
  void SetMonitorMode (void);  
  /**
   * \returns true if device is in monitor mode
   *
   */
  bool IsMonitorMode (void) const;
