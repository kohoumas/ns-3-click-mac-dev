...
YansWifiPhy::SendPacket (Ptr<const Packet> packet, WifiMode txMode, WifiPreamble preamble, uint8_t txPower)
{
  ...
  NotifyMonitorSniffTx (packet, (uint16_t)GetChannelFrequencyMhz (), GetChannelNumber (), dataRate500KbpsUnits, isShortPreamble, txPower);
  ...
  if (m_random.GetValue () > snrPer.per)
    {
      ...
      NotifyMonitorSniffRx (p, (uint16_t)GetChannelFrequencyMhz (), GetChannelNumber (), rate, isShortPreamble, signalDbm, noiseDbm);
